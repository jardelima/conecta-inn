...
export default function InternalPool({ navigation, route }) {
    ...
    useEffect(() => {
        ...
        async function getServices() {
            let response = await fetch(`${url.urlBase}/hotel/${idHotel}/products/pool`, {
                method: "GET",
                headers: {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.containerItems}>
                ...
                <View style={styles.titleContainer}>
                    <Text maxFontSizeMultiplier={1.2} style={[globalStyles.title, styles.title]}>Piscina</Text>  
